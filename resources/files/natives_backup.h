...
namespace VEHICLE
{
	...
	static BOOL ADD_A_MARKER_OVER_VEHICLE(Vehicle vehicle) { return invoke<BOOL>(0x5991A01434CE9677, vehicle); } // 0x5991A01434CE9677 0xAF8CB3DF
	...
	static void _0xE301BD63E9E13CF0(Vehicle cargobob, Vehicle vehicle) { invoke<Void>(0xE301BD63E9E13CF0, cargobob, vehicle); } // 0xE301BD63E9E13CF0
...
namespace UI
{
	...
	static void _CREATE_MP_GAMER_TAG_COLOR(int headDisplayId, char* username, BOOL pointedClanTag, BOOL isRockstarClan, char* clanTag, Any p5, int r, int g, int b) { invoke<Void>(0x6DD05E9D83EFA4C9, headDisplayId, username, pointedClanTag, isRockstarClan, clanTag, p5, r, g, b); } // 0x6DD05E9D83EFA4C9 0xC969F2D0
	...
	static void _SET_MP_GAMER_TAG_HEALTH_BAR_COLOR(int headDisplayId, int color) { invoke<Void>(0x3158C77A7E888AB4, headDisplayId, color); } // 0x3158C77A7E888AB4 0x5777EC77
...
namespace NETWORK
{
	...
	static BOOL _NETWORK_HAS_CONTROL_OF_PAVEMENT_STATS(Hash hash) { return invoke<BOOL>(0xC01E93FAC20C3346, hash); } // 0xC01E93FAC20C3346
